...
public class HistoryController {
    ...
    public ApiResponse<HistoryListResponseDto> list(@AuthenticationPrincipal CustomUserDetails customUserDetails, HistoryListRequestDto historyListRequestDto) {
    ...
    public ApiResponse<HistoryListResponseDto> deliveryList(@AuthenticationPrincipal CustomUserDetails customUserDetails, HistoryListRequestDto historyListRequestDto) {
        Long userId = customUserDetails.getUserId();
    ...
    public ApiResponse<HistoryListResponseDto> requestList(@AuthenticationPrincipal CustomUserDetails customUserDetails, HistoryListRequestDto historyListRequestDto) {
        Long userId = customUserDetails.getUserId();
    ...
    public ApiResponse<HistoryListResponseDto> cancelList(@AuthenticationPrincipal CustomUserDetails customUserDetails, HistoryListRequestDto historyListRequestDto) {
        Long userId = customUserDetails.getUserId();
